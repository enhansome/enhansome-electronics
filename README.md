...
* [Inkscape Electric Symbols](https://github.com/upb-lea/Inkscape_electric_Symbols) ⭐ 559 | 🐛 3 | 📅 2026-02-08 - Circuit Drawing Symbols for Inkscape
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,512 | 🐛 41 | 🌐 Python | 📅 2026-07-12 - A html BOM generation tool for manual pick and place.
* [Xesscorp's list of KiCad 3rd party tools](https://github.com/xesscorp/kicad-3rd-party-tools) ⭐ 836 | 🐛 2 | 📅 2026-05-15
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 730 | 🐛 26 | 🌐 Python | 📅 2026-08-12 - Generate the fabrication and documentation files for your KiCad projects easily, repeatable, and most of all, scriptably.
...
* [delftopenhardware/awesome-open-hardware](https://github.com/delftopenhardware/awesome-open-hardware) ⭐ 1,024 | 🐛 3 | 📅 2026-08-06 - Helpful items for making and learning about open source hardware projects.
* [embedded-boston/awesome-embedded-systems](https://github.com/embedded-boston/awesome-embedded-systems) ⭐ 1,002 | 🐛 8 | 📅 2024-01-04 - Awesome list of embedded programming resources.
...
* [upb-lea/awesome-open-source-power-electronics](https://github.com/upb-lea/awesome-open-source-power-electronics) ⭐ 348 | 🐛 0 | 📅 2026-03-10 - Open source software list specialized on power electronics.
