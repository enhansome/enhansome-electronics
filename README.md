# Awesome Electronics with stars
...
* [Inkscape Electric Symbols](https://github.com/upb-lea/Inkscape_electric_Symbols) ⭐ 570 | 🐛 3 | 📅 2026-02-08 - Circuit Drawing Symbols for Inkscape
...
* [Horizon EDA](https://github.com/horizon-eda/horizon) ⭐ 1,317 | 🐛 167 | 🌐 C | 📅 2026-09-13 - A free and open source EDA tool with the focus on shortcut operation.
...
* [Keyboard PCB Guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,957 | 🐛 22 | 📅 2024-07-02 -  Comprehensive written tutorial that takes you through creating a keyboard PCB.
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,565 | 🐛 43 | 🌐 Python | 📅 2026-09-10 - A html BOM generation tool for manual pick and place.
* [Xesscorp's list of KiCad 3rd party tools](https://github.com/xesscorp/kicad-3rd-party-tools) ⭐ 841 | 🐛 4 | 📅 2026-05-15
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 739 | 🐛 25 | 🌐 Python | 📅 2026-09-11 - Generate the fabrication and documentation files for your KiCad projects easily, repeatable, and most of all, scriptably.
...
* [Awesome KiCad Projects](https://github.com/way2pramil/awesome-kicad-projects) ⭐ 111 | 🐛 0 | 📅 2026-09-13 - Curated list of open source hardware projects whose PCBs are designed in KiCad.
...
* [SparkFun Electronics Eagle Libraries](https://github.com/sparkfun/SparkFun-Eagle-Libraries) ⭐ 1,800 | 🐛 10 | 📅 2024-08-23
...
* [Part-DB](https://github.com/Part-DB/Part-DB) ⭐ 168 | 🐛 36 | 🌐 JavaScript | 📅 2024-04-15 - Another open source web service for managing part inventory with a permission system and a good barcode generator.
...
* [delftopenhardware/awesome-open-hardware](https://github.com/delftopenhardware/awesome-open-hardware) ⭐ 1,063 | 🐛 4 | 📅 2026-08-31 - Helpful items for making and learning about open source hardware projects.
* [embedded-boston/awesome-embedded-systems](https://github.com/embedded-boston/awesome-embedded-systems) ⭐ 1,017 | 🐛 8 | 📅 2024-01-04 - Awesome list of embedded programming resources.
* [intajay/open-electronics](https://github.com/intajay/open-electronics) ⭐ 751 | 🐛 2 | 📅 2024-12-22 - Another GitHub list: resources for Electronics Enthusiasts and Hardware Hackers.
* [cajt/list\_of\_robot\_electronics](https://github.com/cajt/list_of_robot_electronics) ⭐ 447 | 🐛 1 | 📅 2025-07-26 - A GitHub list of resources, projects and products for robot electronics.
* [Vitorian/awesome-fpga](https://github.com/Vitorian/awesome-fpga) ⭐ 400 | 🐛 2 | 📅 2017-05-25 - Awesome list of FPGA resources.
...
* [upb-lea/awesome-open-source-power-electronics](https://github.com/upb-lea/awesome-open-source-power-electronics) ⭐ 363 | 🐛 1 | 📅 2026-09-01 - Open source software list specialized on power electronics.
* [Awesome Lattice FPGAs](https://github.com/kelu124/awesome-latticeFPGAs) ⭐ 362 | 🐛 0 | 📅 2026-07-09 - A curated list of awesome open-source FPGA boards.
