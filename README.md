...
* [Inkscape Electric Symbols](https://github.com/upb-lea/Inkscape_electric_Symbols) ⭐ 565 | 🐛 3 | 📅 2026-02-08 - Circuit Drawing Symbols for Inkscape
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,538 | 🐛 43 | 🌐 Python | 📅 2026-07-12 - A html BOM generation tool for manual pick and place.
...
* [delftopenhardware/awesome-open-hardware](https://github.com/delftopenhardware/awesome-open-hardware) ⭐ 1,039 | 🐛 2 | 📅 2026-08-27 - Helpful items for making and learning about open source hardware projects.
...
* [intajay/open-electronics](https://github.com/intajay/open-electronics) ⭐ 747 | 🐛 2 | 📅 2024-12-22 - Another GitHub list: resources for Electronics Enthusiasts and Hardware Hackers.
...
* [upb-lea/awesome-open-source-power-electronics](https://github.com/upb-lea/awesome-open-source-power-electronics) ⭐ 357 | 🐛 1 | 📅 2026-03-10 - Open source software list specialized on power electronics.
