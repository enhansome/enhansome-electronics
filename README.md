...
* [Horizon EDA](https://github.com/horizon-eda/horizon) ⭐ 1,317 | 🐛 166 | 🌐 C | 📅 2026-09-13 - A free and open source EDA tool with the focus on shortcut operation.
...
* [Keyboard PCB Guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,956 | 🐛 22 | 📅 2024-07-02 -  Comprehensive written tutorial that takes you through creating a keyboard PCB.
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,566 | 🐛 44 | 🌐 Python | 📅 2026-09-10 - A html BOM generation tool for manual pick and place.
...
* [delftopenhardware/awesome-open-hardware](https://github.com/delftopenhardware/awesome-open-hardware) ⭐ 1,062 | 🐛 4 | 📅 2026-08-31 - Helpful items for making and learning about open source hardware projects.
