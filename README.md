...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,569 | 🐛 43 | 🌐 Python | 📅 2026-09-10 - A html BOM generation tool for manual pick and place.
...
* [Awesome KiCad Projects](https://github.com/way2pramil/awesome-kicad-projects) ⭐ 152 | 🐛 0 | 🌐 Python | 📅 2026-09-17 - Curated list of open source hardware projects whose PCBs are designed in KiCad.
...
* [Part-DB](https://github.com/Part-DB/Part-DB) ⭐ 168 | 🐛 37 | 🌐 JavaScript | 📅 2024-04-15 - Another open source web service for managing part inventory with a permission system and a good barcode generator.
...
* [intajay/open-electronics](https://github.com/intajay/open-electronics) ⭐ 751 | 🐛 0 | 📅 2026-09-17 - Another GitHub list: resources for Electronics Enthusiasts and Hardware Hackers.
