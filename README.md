...
* [Horizon EDA](https://github.com/horizon-eda/horizon) ⭐ 1,316 | 🐛 168 | 🌐 C | 📅 2026-09-15 - A free and open source EDA tool with the focus on shortcut operation.
...
* [Keyboard PCB Guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,963 | 🐛 22 | 📅 2024-07-02 -  Comprehensive written tutorial that takes you through creating a keyboard PCB.
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,572 | 🐛 43 | 🌐 Python | 📅 2026-09-10 - A html BOM generation tool for manual pick and place.
...
* [Awesome KiCad Projects](https://github.com/way2pramil/awesome-kicad-projects) ⭐ 165 | 🐛 0 | 🌐 Python | 📅 2026-09-17 - Curated list of open source hardware projects whose PCBs are designed in KiCad.
...
* [delftopenhardware/awesome-open-hardware](https://github.com/delftopenhardware/awesome-open-hardware) ⭐ 1,066 | 🐛 7 | 📅 2026-08-31 - Helpful items for making and learning about open source hardware projects.
...
* [intajay/open-electronics](https://github.com/intajay/open-electronics) ⭐ 749 | 🐛 0 | 📅 2026-09-17 - Another GitHub list: resources for Electronics Enthusiasts and Hardware Hackers.
