...
* [Horizon EDA](https://github.com/horizon-eda/horizon) ⭐ 1,319 | 🐛 165 | 🌐 C | 📅 2026-09-25 - A free and open source EDA tool with the focus on shortcut operation.
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,577 | 🐛 43 | 🌐 Python | 📅 2026-09-10 - A html BOM generation tool for manual pick and place.
* [Xesscorp's list of KiCad 3rd party tools](https://github.com/xesscorp/kicad-3rd-party-tools) ⭐ 842 | 🐛 4 | 📅 2026-05-15
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 744 | 🐛 25 | 🌐 Python | 📅 2026-09-25 - Generate the fabrication and documentation files for your KiCad projects easily, repeatable, and most of all, scriptably.
...
* [Awesome KiCad Projects](https://github.com/way2pramil/awesome-kicad-projects) ⭐ 184 | 🐛 0 | 🌐 Python | 📅 2026-09-17 - Curated list of open source hardware projects whose PCBs are designed in KiCad.
...
* [delftopenhardware/awesome-open-hardware](https://github.com/delftopenhardware/awesome-open-hardware) ⭐ 1,076 | 🐛 7 | 📅 2026-08-31 - Helpful items for making and learning about open source hardware projects.
* [embedded-boston/awesome-embedded-systems](https://github.com/embedded-boston/awesome-embedded-systems) ⭐ 1,019 | 🐛 8 | 📅 2024-01-04 - Awesome list of embedded programming resources.
...
* [Awesome Lattice FPGAs](https://github.com/kelu124/awesome-latticeFPGAs) ⭐ 362 | 🐛 0 | 📅 2026-09-25 - A curated list of awesome open-source FPGA boards.
