...
* [Horizon EDA](https://github.com/horizon-eda/horizon) ⭐ 1,315 | 🐛 164 | 🌐 C | 📅 2026-09-09 - A free and open source EDA tool with the focus on shortcut operation.
...
* [Keyboard PCB Guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,953 | 🐛 22 | 📅 2024-07-02 -  Comprehensive written tutorial that takes you through creating a keyboard PCB.
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,563 | 🐛 43 | 🌐 Python | 📅 2026-09-09 - A html BOM generation tool for manual pick and place.
