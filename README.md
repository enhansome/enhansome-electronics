...
* [Horizon EDA](https://github.com/horizon-eda/horizon) ⭐ 1,315 | 🐛 162 | 🌐 C | 📅 2026-08-28 - A free and open source EDA tool with the focus on shortcut operation.
...
* [Keyboard PCB Guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,952 | 🐛 22 | 📅 2024-07-02 -  Comprehensive written tutorial that takes you through creating a keyboard PCB.
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,560 | 🐛 43 | 🌐 Python | 📅 2026-09-09 - A html BOM generation tool for manual pick and place.
* [Xesscorp's list of KiCad 3rd party tools](https://github.com/xesscorp/kicad-3rd-party-tools) ⭐ 841 | 🐛 4 | 📅 2026-05-15
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 739 | 🐛 27 | 🌐 Python | 📅 2026-09-07 - Generate the fabrication and documentation files for your KiCad projects easily, repeatable, and most of all, scriptably.
...
* [delftopenhardware/awesome-open-hardware](https://github.com/delftopenhardware/awesome-open-hardware) ⭐ 1,052 | 🐛 2 | 📅 2026-08-31 - Helpful items for making and learning about open source hardware projects.
...
* [intajay/open-electronics](https://github.com/intajay/open-electronics) ⭐ 750 | 🐛 2 | 📅 2024-12-22 - Another GitHub list: resources for Electronics Enthusiasts and Hardware Hackers.
...
* [upb-lea/awesome-open-source-power-electronics](https://github.com/upb-lea/awesome-open-source-power-electronics) ⭐ 362 | 🐛 0 | 📅 2026-09-01 - Open source software list specialized on power electronics.
