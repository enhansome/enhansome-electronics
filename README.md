...
* [Horizon EDA](https://github.com/horizon-eda/horizon) ⭐ 1,315 | 🐛 166 | 🌐 C | 📅 2026-09-10 - A free and open source EDA tool with the focus on shortcut operation.
...
* [Keyboard PCB Guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,954 | 🐛 22 | 📅 2024-07-02 -  Comprehensive written tutorial that takes you through creating a keyboard PCB.
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,564 | 🐛 43 | 🌐 Python | 📅 2026-09-10 - A html BOM generation tool for manual pick and place.
...
* [delftopenhardware/awesome-open-hardware](https://github.com/delftopenhardware/awesome-open-hardware) ⭐ 1,056 | 🐛 3 | 📅 2026-08-31 - Helpful items for making and learning about open source hardware projects.
...
* [intajay/open-electronics](https://github.com/intajay/open-electronics) ⭐ 752 | 🐛 2 | 📅 2024-12-22 - Another GitHub list: resources for Electronics Enthusiasts and Hardware Hackers.
...
* [upb-lea/awesome-open-source-power-electronics](https://github.com/upb-lea/awesome-open-source-power-electronics) ⭐ 362 | 🐛 1 | 📅 2026-09-01 - Open source software list specialized on power electronics.
