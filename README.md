...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,557 | 🐛 44 | 🌐 Python | 📅 2026-09-02 - A html BOM generation tool for manual pick and place.
* [Xesscorp's list of KiCad 3rd party tools](https://github.com/xesscorp/kicad-3rd-party-tools) ⭐ 841 | 🐛 4 | 📅 2026-05-15
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 739 | 🐛 28 | 🌐 Python | 📅 2026-09-07 - Generate the fabrication and documentation files for your KiCad projects easily, repeatable, and most of all, scriptably.
...
* [delftopenhardware/awesome-open-hardware](https://github.com/delftopenhardware/awesome-open-hardware) ⭐ 1,050 | 🐛 2 | 📅 2026-08-31 - Helpful items for making and learning about open source hardware projects.
...
* [intajay/open-electronics](https://github.com/intajay/open-electronics) ⭐ 749 | 🐛 2 | 📅 2024-12-22 - Another GitHub list: resources for Electronics Enthusiasts and Hardware Hackers.
* [cajt/list\_of\_robot\_electronics](https://github.com/cajt/list_of_robot_electronics) ⭐ 444 | 🐛 1 | 📅 2025-07-26 - A GitHub list of resources, projects and products for robot electronics.
